...
class CTABGANSynthesizer:
    def __init__(self,
        ...
        self.clip_coeff = 1
        self.sigma = 1.9
        # 1.9 epsilon 1 for others
        # 0.389 epsilon 100 for others
        # 0.454 epsilon 100 for loan
        # 1.1748
        #1.02
    ...
    def fit(self, train_data=pd.DataFrame, categorical=[], mixed={}, general=[], non_categorical=[], type={}):
        ...
        for i in tqdm(range(self.epochs)):
            ...
            # epoch += 1
            if self.private and i == 9:
                print(self.batch_size, train_data.shape[0], steps, self.sigma)
                max_lmbd = 4095
